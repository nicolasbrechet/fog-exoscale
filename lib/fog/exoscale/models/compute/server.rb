  ...
  module Compute
    class Exoscale
      class Server < Fog::Compute::Server
        ...
        def destroy(options = {})
          requires :id
          data = service.destroy_virtual_machine(options.merge('id' => id))
        ...
        def reboot
          requires :id
          data = service.reboot_virtual_machine('id' => id) # FIXME: does this ever fail?
        ...
        def security_group_ids
          @security_group_ids || (security_group_list || []).map { |sg| sg['id'] }
        end
        ...
        def start
          requires :id
          data = service.start_virtual_machine('id' => id)
        ...
        def stop(options = {})
          ...
          data = service.stop_virtual_machine(options.merge('id' => id))
